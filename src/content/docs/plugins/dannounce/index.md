---
title: "DAnnounce"
description: "DAnnounce rotates announcements through chat on a timer, and can also schedule individual ones for a fixed date, a time of day, or a day of the week. Every…"
---

**DAnnounce** rotates announcements through chat on a timer, and can also schedule individual ones for a fixed date, a time of day, or a day of the week. Every announcement is a title, some lines and an optional clickable call to action, and players can switch the whole thing off for themselves.
...
The full list, with what to do about each, is on [Known Limitations](/plugins/dannounce/limitations/).
...
| Java | **25+** |
| DzusillCore (DzusillCore) | **1.12.0+** (required, separate jar) |
...
See [Requirements](/plugins/dannounce/getting-started/requirements/).
  ...
  └─ is anything due?              next fire time per announcement, in your timezone
     └─ pick a variant             rotate (in order) or random (never twice running)
        └─ for each online player
           ├─ have they muted announcements?      unless dannounce.bypass-toggle
           ├─ is dannounce.receive.<id> denied?   unset = yes, receive it
...
- [Requirements](/plugins/dannounce/getting-started/requirements/)
- [Installation](/plugins/dannounce/getting-started/installation/)
- [Quick Start](/plugins/dannounce/getting-started/quick-start/)
- [Channels](/plugins/dannounce/features/channels/)
- [Schedules](/plugins/dannounce/features/schedules/)
- [Sound](/plugins/dannounce/features/sound/)
- [config.yml reference](/plugins/dannounce/configuration/config/)
- [Commands & Permissions](/plugins/dannounce/commands-and-permissions/)
- [Known Limitations](/plugins/dannounce/limitations/)
- [FAQ & Troubleshooting](/plugins/dannounce/faq/)
