...
6. **Closes** any open buy menus and **refreshes** every open shop GUI to the new items.
7. **Opens** the market for this rotation (see [Opening Hours](/plugins/drotatingshop/features/opening-hours/)).
