...
Patterns are matched against the item's [keys](/plugins/ddonutworth/features/item-keys/), so
...
Tier icons render as unlocked / in progress / locked, styled in [gui/multipliers.yml](/plugins/ddonutworth/configuration/guis/).
...
Tiers are high-water marks — see [Sell Multipliers](/plugins/ddonutworth/features/sell-multipliers/) for what that
