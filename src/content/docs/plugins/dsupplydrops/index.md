---
title: "dSupplyDrops"
description: "Scheduled supply drop events for Paper, built on DzusillCore."
---

Scheduled supply drop events for Paper, built on DzusillCore.
...
New install: [Installation](/plugins/dsupplydrops/getting-started/installation/), then
[Quick start](/plugins/dsupplydrops/getting-started/quick-start/).

Tuning an existing one: [The drop lifecycle](/plugins/dsupplydrops/features/drop-lifecycle/) explains what each timing
actually controls.
