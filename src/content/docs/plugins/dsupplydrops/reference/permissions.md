...
| Node | Default | Grants |
|---|---|---|
| `dsupplydrops.use` | everyone | `/supplydrop`, `/supplydrop active`, `/supplydrop stats` |
| `dsupplydrops.preview` | everyone | `/supplydrop preview` |
| `dsupplydrops.next` | everyone | `/supplydrop next` |
| `dsupplydrops.locate` | everyone | `/supplydrop locate` |
| `dsupplydrops.top` | everyone | `/supplydrop top` |
| `dsupplydrops.notify` | everyone | Receives drop announcements, titles and the boss bar |
| `dsupplydrops.admin` | operator | `spawn`, `clear`, `zone`, `reload`, and coordinates in `/supplydrop active` |
...
The staff subcommands all share `dsupplydrops.admin`. They are destructive in the same way —
