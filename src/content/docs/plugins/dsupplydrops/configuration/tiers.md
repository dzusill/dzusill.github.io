...
Rarity tiers and their loot tables. See [Tiers and loot](/plugins/dsupplydrops/features/tiers-and-loot/) for how the
...
The full key reference is in [Holograms](/plugins/dsupplydrops/features/holograms/).
