...
See [WorldGuard regions](/plugins/dsupplydrops/features/regions/) for the overlap rules.
...
`ITEM` and `BLOCK` types cost you: [Holograms](/plugins/dsupplydrops/features/holograms/).
...
[Notifications](/plugins/dsupplydrops/features/notifications/#routing-one-event-somewhere-else).
