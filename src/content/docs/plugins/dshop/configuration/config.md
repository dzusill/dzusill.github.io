...
See [Currencies](/plugins/dshop/features/currencies/).
...
See [Pricing & Sales](/plugins/dshop/features/pricing-and-sales/) and
...
See [Custom Items](/plugins/dshop/features/custom-items/).
...
For `/adminshop import perfshop`. See [Migrating from PerfShop](/plugins/dshop/migrating-from-perfshop/).
