...
[Currencies](/plugins/dshop/features/currencies/#command-currencies).
...
No. DShop is purchase-only; selling is [dSell](https://github.com/dzusill/dSell)'s job.
...
Yes. All scheduling goes through DzusillCore's platform abstraction.
