...
This is worth being explicit about: DSell does **not** depend on MMOItems, Oraxen, Nexo or
...
See [Readable Item Keys](/plugins/dsell/features/item-keys/) for how those are matched, and why durability is deliberately not
...
See [Sell Categories](/plugins/dsell/configuration/sell-categories/).
