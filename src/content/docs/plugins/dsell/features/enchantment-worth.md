...
The values live in [enchantments.yml](/plugins/dsell/configuration/enchantments/), which ships with **42** vanilla
...
[enchantments.yml](/plugins/dsell/configuration/enchantments/):
