...
`sell/<id>.yml`; see [Sell Categories](/plugins/dsell/configuration/sell-categories/) to retune, add or remove one.
...
Requires `dsell.admin`, and works on an offline player.
