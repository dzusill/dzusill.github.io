...
Patterns are matched against the item's [keys](/plugins/dsell/features/item-keys/), so
...
Tier icons render as unlocked / in progress / locked, styled in [gui/multipliers.yml](/plugins/dsell/configuration/guis/).
...
Tiers are high-water marks — see [Sell Multipliers](/plugins/dsell/features/sell-multipliers/) for what that
