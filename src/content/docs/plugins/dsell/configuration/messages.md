...
[`config.yml`](/plugins/dsell/configuration/config/#presentation). Set a category once, or override any exact key:
...
payout and item count. Changes are live after `/dsell reload`.
