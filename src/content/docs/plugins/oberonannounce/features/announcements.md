...
- the permission node `oberonannounce.receive.<id>`
- `join.announcement`
...
So a PlaceholderAPI placeholder that returns MiniMessage tags will have them rendered. See [Placeholders](/plugins/oberonannounce/placeholders/).
