---
title: "OberonSell"
description: "OberonSell gives every item a sell price. Players check what something is worth, sell it from their"
---

**OberonSell** gives every item a sell price. Players check what something is worth, sell it from their
...
- 💵 **One price file, already filled in** — `prices.yml` ships 1,616 item prices plus an enchantment
  table. Edit a line, delete a line, or add your own under `items:`. See [Pricing](/plugins/oberonsell/features/pricing/).
- 📝 **Keys you can actually read** — `POTATO: 500.0`, not `item_17: 7000.0`. Find an item, change it,
  delete it. See [Readable Item Keys](/plugins/oberonsell/features/item-keys/).
...
- 🏷️ **Worth lore everywhere** — tooltips show what an item is worth in chests, ender chests, barrels, the
  player's own inventory and any GUI you list. See [Worth Lore](/plugins/oberonsell/features/worth-lore/).
...
- 🪄 **`/setworth` on anything** — vanilla, enchanted, custom-model-data, or a sword from MMOItems, Oraxen,
  Nexo or ItemsAdder. See [Custom Items](/plugins/oberonsell/features/custom-items/).
- 📈 **Per-category sell multipliers** — nine categories out of the box, each with a twenty-tier ladder and
  its own progress page. See [Sell Multipliers](/plugins/oberonsell/features/sell-multipliers/).
- 🪓 **A sell axe** — right-click a container to sell everything inside. The expiry lives on the item, so it
  survives restarts and can be traded. See [The Sell Axe](/plugins/oberonsell/features/the-sell-axe/).
...
- [Installation](/plugins/oberonsell/getting-started/installation/) · [Quick Start](/plugins/oberonsell/getting-started/quick-start/)
- [Pricing](/plugins/oberonsell/features/pricing/) · [Readable Item Keys](/plugins/oberonsell/features/item-keys/)
- [prices.yml reference](/plugins/oberonsell/configuration/prices/) · [config.yml reference](/plugins/oberonsell/configuration/config/)
- [Commands & Permissions](/plugins/oberonsell/commands-and-permissions/)
- [FAQ & Troubleshooting](/plugins/oberonsell/faq/)
