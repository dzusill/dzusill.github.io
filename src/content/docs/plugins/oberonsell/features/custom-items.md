...
This is worth being explicit about: OberonSell does **not** depend on MMOItems, Oraxen, Nexo or
...
See [Readable Item Keys](/plugins/oberonsell/features/item-keys/) for how those are matched, and why durability is deliberately not
...
See [Sell Categories](/plugins/oberonsell/configuration/sell-categories/).
