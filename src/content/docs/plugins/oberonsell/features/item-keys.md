...
Every item has a **key** — the name it goes by in [prices.yml](/plugins/oberonsell/configuration/prices/), in
...
> This is a deliberate departure from the reference plugin OberonSell replaces, which stored prices as
...
The same grammar keys all three sections of [prices.yml](/plugins/oberonsell/configuration/prices/): your own `items`
...
[Migration health](/plugins/oberonsell/configuration/prices/#migration-health) for the counts.
