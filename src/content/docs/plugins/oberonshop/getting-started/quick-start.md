...
`legacy-shards`. See [Currencies](/plugins/oberonshop/features/currencies/).
...
made. See [Variants](/plugins/oberonshop/features/variants/) — `shops/_example_variants.yml` has a worked example of
...
[Pricing & Sales](/plugins/oberonshop/features/pricing-and-sales/).
