...
`%ddonations_board_<id>_name%` and `%ddonations_board_<id>_value%` — useful for repeating a board's top line elsewhere, like a scoreboard.

## See also

- [boards.yml reference](/plugins/ddonations/configuration/boards-yml/)
