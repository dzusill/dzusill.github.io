...
description: "dDonations replaces PerfDonation and imports its history automatically — nothing to run by hand under normal circumstances."
---

dDonations replaces PerfDonation and imports its history automatically — nothing to run by hand under normal circumstances.
...
- [Installation](/plugins/ddonations/getting-started/installation/#migrating-an-existing-perfdonation-install)
