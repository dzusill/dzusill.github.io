...
- [Announcements](/plugins/ddonations/features/announcements/) — the same events, presented in-game
- [webhooks.yml reference](/plugins/ddonations/configuration/webhooks-yml/)
