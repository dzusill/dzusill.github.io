...
Presentation lives in `announcements.yml`, under the `gg-start`, `gg-end` and `gg-cancelled` events. See [Announcements](/plugins/ddonations/features/announcements/).
...
- [Hype Train](/plugins/ddonations/features/hype-train/) — the other purchase-driven event, independent of this one
- [ggwave.yml reference](/plugins/ddonations/configuration/ggwave-yml/)
