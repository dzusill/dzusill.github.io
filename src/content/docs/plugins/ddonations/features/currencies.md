...
A purchase is always shown in the currency it was actually paid in. A €2.09 donation reads €2.09; a $4.99 one reads $4.99. Nothing is ever converted, anywhere, and that will not change — see [Known Limitations](/plugins/ddonations/limitations/).
