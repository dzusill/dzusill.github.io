---
title: "dDonations"
description: "dDonations watches your Tebex (or CraftingStore) store and turns every purchase into engagement: multi-channel announcements with the donor's real face…"
---

**dDonations** watches your Tebex (or CraftingStore) store and turns every purchase into engagement: multi-channel announcements with the donor's real face drawn in chat, Hype Trains, GG Waves, community goals, in-world donation boards and Discord embeds — plus donor statistics and leaderboards through PlaceholderAPI.

It is built on [DzusillCore](https://github.com/dzusill/DzusillCore) (shipped as **DzusillCore**).
...
- 🏷️ **Your own name for every package** — a store package called `Nebula Rank (Monthly) - MyServer` reads as a gold-gradient **⭐ Nebula Rank** in game, in Discord and on the leaderboards, and can bring its own announcement and embed with it. `/donations packages` finds what your store sends and writes the entries for you.
...
- 🧩 **PlaceholderAPI** — `%ddonations_…%` for totals, goals, the hype train, GG wave, boards and per-donor stats, all served from a cache so a scoreboard reading them every tick never touches the database.
...
The full list, with what to do about each, is on [Known Limitations](/plugins/ddonations/limitations/).
...
| Java | **25+** |
| DzusillCore (DzusillCore) | required, separate jar |
| A Tebex store | Plugin API secret from the Game Servers panel |
| PlaceholderAPI | optional — enables `%ddonations_…%` |
...
See [Requirements](/plugins/ddonations/getting-started/requirements/).
...
- [Requirements](/plugins/ddonations/getting-started/requirements/)
- [Installation](/plugins/ddonations/getting-started/installation/)
- [Quick Start](/plugins/ddonations/getting-started/quick-start/)
- [Announcements](/plugins/ddonations/features/announcements/)
- [Package Display Names](/plugins/ddonations/features/package-display-names/)
- [The Donor's Head in Chat](/plugins/ddonations/features/player-heads/)
- [Hype Train](/plugins/ddonations/features/hype-train/)
- [GG Wave](/plugins/ddonations/features/gg-wave/)
- [Community Goals](/plugins/ddonations/features/community-goals/)
- [Donation Boards](/plugins/ddonations/features/donation-boards/)
- [Migrating from PerfDonation](/plugins/ddonations/features/migrating-from-perfdonation/)
- [config.yml reference](/plugins/ddonations/configuration/config/)
- [Commands & Permissions](/plugins/ddonations/commands-and-permissions/)
- [Known Limitations](/plugins/ddonations/limitations/)
- [FAQ & Troubleshooting](/plugins/ddonations/faq/)
