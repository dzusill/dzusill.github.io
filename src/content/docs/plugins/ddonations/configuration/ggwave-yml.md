...
The GG Wave's mechanics. Presentation lives in `announcements.yml` instead — see [GG Wave](/plugins/ddonations/features/gg-wave/) for how triggering, entering and rewarding fit together.
