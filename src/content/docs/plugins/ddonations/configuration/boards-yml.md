...
Donation board rendering. See [Donation Boards](/plugins/ddonations/features/donation-boards/) for what each renderer and section actually does — this page is the file laid out in full.
...
- [Known Limitations](/plugins/ddonations/limitations/) — `npc.type: skin` verification status by backend
