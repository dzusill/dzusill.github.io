...
The Hype Train's mechanics. Presentation lives in `announcements.yml` instead — see [Hype Train](/plugins/ddonations/features/hype-train/) for how the ladder and timer actually work together.
