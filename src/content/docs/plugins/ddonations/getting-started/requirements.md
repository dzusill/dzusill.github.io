...
| Java | **25+** | |
| DzusillCore | required | The DzusillCore framework, shipped under this coordinate. A separate jar, installed first |
...
| PlaceholderAPI | optional | Enables the `%ddonations_…%` expansion |
...
See [Installation](/plugins/ddonations/getting-started/installation/) next.
